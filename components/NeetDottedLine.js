...
// const NeetDottedline = ({ top, left, onHover }) => {
//   const router = useRouter();

//   const navigate = (grade) => {
//     const formattedGrade = grade.replace(/\s+/g, "-");
//     router.push(`/courses/neet/${formattedGrade}`);
//   };
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center">
          <svg width="90" height="50" viewBox="0 0 46.8 30">
            <rect x="2" y="2" width="60" height="25" fill="#cc0000" />
            <line x1="2.4" y1="40" x2="2.4" y2="2" stroke="#001F3F" strokeWidth="2" />
            <text x="8" y="20" fill="white" fontSize="16" fontWeight="bold">
              NEET
            </text>
          </svg>
        </div>
            ...
            return (
              <g key={grade}>
                ...
                <rect
                  ...
                  height={buttonHeight}
                  rx={15} // Round corners
                  fill={hoverColor === grade ? "#0047AB" : "green"} // Change color on hover
                  style={{
                    cursor: "pointer",
